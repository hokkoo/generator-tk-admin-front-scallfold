...
<script>
import PanThumb from '@elementAdmin/components/PanThumb'
import MdInput from '@elementAdmin/components/MDinput'
import Mallki from '@elementAdmin/components/TextHoverEffect/Mallki'
import DropdownMenu from '@elementAdmin/components/Share/dropdownMenu'
import waves from '@elementAdmin/directive/waves/index.js' // 水波纹指令
