...
<script>
import clip from '@elementAdmin/utils/clipboard' // use clipboard directly
import clipboard from '@elementAdmin/directive/clipboard/index.js' // use clipboard by v-directive
