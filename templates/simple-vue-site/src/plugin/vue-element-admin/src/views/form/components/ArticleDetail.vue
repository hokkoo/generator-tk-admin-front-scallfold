...
<script>
import Tinymce from '@elementAdmin/components/Tinymce'
import Upload from '@elementAdmin/components/Upload/singleImage3'
import MDinput from '@elementAdmin/components/MDinput'
import Multiselect from 'vue-multiselect'// 使用的一个多选框组件，element-ui的select不能满足所有需求
import 'vue-multiselect/dist/vue-multiselect.min.css'// 多选框组件css
import Sticky from '@elementAdmin/components/Sticky' // 粘性header组件
import { validateURL } from '@elementAdmin/utils/validate'
import { fetchArticle } from '@elementAdmin/api/article'
import { userSearch } from '@elementAdmin/api/remoteSearch'
