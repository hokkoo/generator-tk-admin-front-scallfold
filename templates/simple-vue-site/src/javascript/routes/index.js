...
/* Layout */
import Layout from '../../component/ui/admin-layout/Layout.vue';
...
export const constantRouterMap = [
	{
		path: '/login',
		component: resolve => require(['@/component/page/login/index.vue'], resolve),
		hidden: true
	},
	...
	// { path: '/401', component: _import('errorPage/401'), hidden: true },
	{
		...
		children: [{
			path: 'home',
			component: resolve => require(['@/component/page/home/home.vue'], resolve),
			name: 'home',
			meta: { title: 'home', icon: 'address-card', noCache: true }
		}]
	}
	// {
	// 	path: '/documentation',
...
export const asyncRouterMap = [
	{
		path: '/permission',
		component: Layout,
		redirect: '/permission/about',
		meta: { roles: ['admin'] },//, // you can set roles in root nav
		children: [{
			path: 'about',
			component: resolve => require(['@/component/page/about/about.vue'], resolve),
			name: 'about',
			meta: {
				title: 'about',
				icon: 'lock',
...

	{
		...
		children: [{
			path: 'index',
			component: resolve => require(['@elementAdmin/views/svg-icons/index.vue'], resolve),
			name: 'icons',
			meta: {
				title: 'icons',
				icon: 'bicycle',
